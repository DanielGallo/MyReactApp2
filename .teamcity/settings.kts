...
project {
    ...
    vcsRoot(MyReactApp2RefsHeadsMaster)
...
object ProductionBuild : BuildType({
    ...
    vcs {
        root(MyReactApp2RefsHeadsMaster)
    }
...
object MyReactApp2RefsHeadsMaster : GitVcsRoot({
    name = "https://github.com/DanielGallo/MyReactApp2#refs/heads/master"
    url = "https://github.com/DanielGallo/MyReactApp2"
})
